...
public class BallStress4 extends BasicGame{
	...
	public void render(GameContainer container, Graphics g)throws SlickException {
		...
		Point p1=new Point((int)(Math.random()*container.getWidth()),(int)(Math.random()*container.getHeight()));
		Point p2=new Point((int)(Math.random()*container.getWidth()),(int)(Math.random()*container.getHeight()));
		if(changeColor)
			g2.setColor(new Color((int)(Math.random()*265),(int)(Math.random()*265),(int)(Math.random()*265)));
		g2.drawLine(p1.x, p1.y, p2.x, p2.y);
		g2.setColor(Color.black);	
		int r=60;
		if(mouse)
			g2.fillOval(container.getInput().getMouseX()-r/2, container.getInput().getMouseY()-r/2,r,r);
