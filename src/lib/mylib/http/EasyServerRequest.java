...
public final class EasyServerRequest {
	...
	/** Connects to the given <code>URL</code> and returns the request. 
	 * Request is <code>null</code> if the <code>URL</code> is not reachable. 
	...
	/** Connects to the given url <code>String</code> and returns the request. 
	 * Request is <code>null</code> if the url is not reachable. </br>
