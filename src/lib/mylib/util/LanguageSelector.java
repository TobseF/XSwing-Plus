...
public class LanguageSelector {
	...
	private LanguageSelector(String language) {
		...
		try {
			langProperties.load(ResourceLoader.getResourceAsStream(
					languageFileLocation + language + LanguageFileExtension));
	...
	public static String setSystemLanguage(){
		String language = System.getProperty("user.language"); //TODO: load mapping from property file 
