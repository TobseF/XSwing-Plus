...
/** Returns Date and version as string of a "version" file which have 
 * to be locatet in src main dir or in jar.</br>
 * version file syntax:<pre>
 * #Build info			#... (info)
 * #Sun May 03 10:40:20 CEST 2009	#... (date)
 * version=v0.6			version=... (version)</pre>
 * @author Tobse
 */
public final class Version {
	...
	/** Tries to find the {@link #VERSION_FILE} in classpaph and in source folder.
	 * Returns a <code>Scanner</code> loaded with the file, or <code>null</code> if file
	 * was not found
	...
	private static Scanner getScanner(){
		...
		try{
			...
			try{
			scanner = new Scanner(ResourceLoader.getResourceAsStream("src/" + VERSION_FILE));
