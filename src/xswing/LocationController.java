...
public class LocationController {
	public enum GameComponentLocation{CENTER, LEFT, RIGHT};
	...
	public LocationController(GameComponentLocation location) {
		multiplayer = (location == GameComponentLocation.LEFT ||
				location == GameComponentLocation.RIGHT);
		switch (location) {
		case CENTER:
	...
	public void setLocationToObject(SObject object){
		...
		if(point == null){ //throw new IllegalArgumentException("Klass not in LocationController List");
