...
public class BallFactory {
	...
	public BallFactory(BallEventListener ballEventListener, BallTable ballTable, SObjectList ballsToMove, Font font, 
			SpriteSheet[] spriteSheet, EffectCatalog effectCatalog, 
	...
	public void toggleSpriteSheet(){
		currentSpriteSheetNr = currentSpriteSheetNr < spriteSheet.length-1 ?  
				currentSpriteSheetNr+1 : 0;
