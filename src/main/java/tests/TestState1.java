...
public class TestState1 extends BasicGameState implements ScreenController {
    ...
    private Nifty nifty;
    private final List<MouseInputEvent> mouseEvents = new ArrayList<MouseInputEvent>();
    private int mouseX;
    private int mouseY;
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        // create nifty
        nifty = new Nifty(new RenderDeviceLwjgl(), new SoundSystem(new SlickSoundDevice()),
                new InputSystem() {
        ...
        nifty.fromXml("tests/overlay.xml", "start", this);
    ...
    private void forwardMouseEventToNifty(final int mouseX, final int mouseY,
        ...
        mouseEvents
                .add(new MouseInputEvent(mouseX, container.getHeight() - mouseY, mouseDown));
    }
